...
class test_reg_page(unittest.TestCase):
	def test_registration_page_1(self):
		...
		self.assertEqual("Congratulations! You have successfully registered!", welcome_text, "Registration page #1 — not passed")
	...
	def test_registration_page_2(self):
		...
		welcome_text_elt = browser.find_element_by_tag_name("h1")
		welcome_text = welcome_text_elt.text
		self.assertEqual("Congratulations! You have successfully registered!", welcome_text, "Registration page #2 — not passed")
